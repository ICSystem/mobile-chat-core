...
(function(global) {
    var emptyFn = function(){},
        ...
        documentUri = typeof Klb != 'undefined' ? Klb.documentUri : documentLocation.protocol + '//' + documentLocation.hostname + documentLocation.pathname + documentLocation.search,
...
console.log(' documentUri - ' +  documentUri );
    ...
    function Manifest(manifest) {
        ...
        var applicationId = manifest.id,
            ...
            assetMap = {};
console.log(' getManifestStorageKey - ' +  key + ' __ applicationId:' + applicationId );
