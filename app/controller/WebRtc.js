...
Ext.define('KlbIm.controller.WebRtc', {
    ...
    createPeerConnection : function () {
        ...
        if (me.pc) {
            ...
            me.pc.onmessage      = Ext.bind(me.onRemoteMessageReceived, me);
        }
    ...
    // receiving text message via WebRTC
    onRemoteMessageReceived: function(message) {
