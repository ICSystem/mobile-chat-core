 ...
 *     });
 */
Ext.define('Ext.ux.util.Observable', function(Observable) {
    ...
    return {
        ...
        requires: ['Ext.event.Event', 'Ext.EventManager'],
        ...
        addListener: function(ename, fn, scope, options) {
            ...
            // String, function passed
                ...
                if (event && event.isEvent) {
                    ...
                    me.events[ename] = event = new Ext.event.Event(me, ename);
                }
                //<debug>
                if (!fn) {
                    Ext.Error.raise('No function passed for event ' + me.$className + '.' + ename);
            ...
            if (eventNames) {
                ...
                for (i = 0; i < length; ++i) {
                    ...
                    if (!event || typeof event == 'boolean') {
                        events[ename] = event = new Ext.event.Event(me, ename);
                    }
