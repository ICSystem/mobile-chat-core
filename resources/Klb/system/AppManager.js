...
Ext.define('Klb.system.AppManager', {
    ...
    constructor: function(config) {
        ...
        for(var i=0; i<enabledApps.length; i++) {
            app = enabledApps[i];
            // if the app is not in the namespace, we don't initialise it we don't have a Api 'Application'
...
//       var modulepath = Klb.Functions.getModulePath( appName );
    ...
    getAppObj: function(app) {
       try{
            ...
            if (typeof(Klb.App[app.appName].getPanel) == 'function') {
                ...
                var     appObj = {}
                      , classApp = this.prefixApp + '.' + app.appName + '.' + app.appName;

            return Ext.create('Klb.system.Application', { appName: app.appName } );
    ...
    console.log('create 1:  ' + classApp);
                ...
                var appObj = Klb.App[app.appName].getMVC('Application')
                                                ...
                                                : new Klb.system.Application(app);   //  alert('new Klb.system.Application(app)');
    ...
    loadAppCss : function( appclass, filename){
        ...
        Klb.system.loadCss(filecss, appclass);
    },
...
//            config = me.app.getConfigApplication(config);
